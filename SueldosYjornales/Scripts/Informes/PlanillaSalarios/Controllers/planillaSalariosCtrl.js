    ...
    function planillaSalariosCtrl($scope, $timeout, $rootScope, sYjResource) {
        ...
        vm.mostrarOcultarFila = function (event, liquidacion) {
            if (!event.target.checked) {
                ...
                //Se quitan los deselecionados
                //_.each(vm.listLiquidaciones, function (liqui, key) {
                //    if (liqui.mostrar == false && liqui.nroItem != 0) {
                //        vm.listLiquidaciones = _.without(vm.listLiquidaciones, _.findWhere(vm.listLiquidaciones, {
                //            nroItem: liqui.nroItem
                //        }));
                //    }
                //});
